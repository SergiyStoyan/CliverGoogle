...
//        Google.Apis.Drive.v3.Data.File getCachedObject(string baseFolderIdOrLink, string relativeObjectPath, Func<Google.Apis.Drive.v3.Data.File> getObject)
//        {
//            string baseFolderId = GetObjectId(baseFolderIdOrLink);
//            string objectPath = "{" + baseFolderId + "}\\" + relativeObjectPath;
//            if (!paths2object.TryGetValue(objectPath, out Google.Apis.Drive.v3.Data.File @object))
//            {
//                @object = getObject();
//                if (@object != null)
//                    paths2object[objectPath] = @object;
//            }
//            return @object;
//        }
...
//        }
//        public Google.Apis.Drive.v3.Data.File GetFolder(string parentFolderIdOrLink, string folderName, GettingMode gettingMode, string fields = "id, webViewLink")
//        {
//            return getCachedObject(parentFolderIdOrLink, folderName, () =>
//              {
...
//        public Google.Apis.Drive.v3.Data.File GetFolder2(string baseFolderIdOrLink, string relativeFolderPath, GettingMode gettingMode, string fields = "id, webViewLink")
//        {
//            string parentFolderId = GetObjectId(baseFolderIdOrLink);
//            string folderPath = "{" + parentFolderId + "}\\" + relativeFolderPath;
//            if (!paths2object.TryGetValue(folderPath, out Google.Apis.Drive.v3.Data.File folder))
//            {
//                foreach (string folderName in relativeFolderPath.Split('\\'))
//                {
//                    folder = GetFolder(parentFolderId, folderName, gettingMode, fields);
//                    parentFolderId = folder.Id;
//                }
//                if (folder != null)
//                    paths2object[folderPath] = folder;
//            }
//            return folder;
//        }
...
//        public Google.Apis.Drive.v3.Data.File GetFile2(string baseFolderIdOrLink, string relativeFilePath, string fields = "id, webViewLink")
//        {
//            if (relativeFilePath == null)
//                throw new Exception2("relativeFilePath is not set.");
//            string baseFolderId = GetObjectId(baseFolderIdOrLink);
//            string filePath = "{" + baseFolderId + "}\\" + relativeFilePath;
//            if (!paths2object.TryGetValue(filePath, out Google.Apis.Drive.v3.Data.File @object))
//            {
//                Google.Apis.Drive.v3.Data.File parentFolder = GetFolder(baseFolderIdOrLink, PathRoutines.GetFileDir(relativeFilePath), GettingMode.GetLatestExistingOnly);
//                if (parentFolder == null)
//                    return null;
//                SearchFilter sf = new SearchFilter { IsFolder = false, ParentId = parentFolder.Id, Name = PathRoutines.GetFileName(relativeFilePath) };
//                IEnumerable<Google.Apis.Drive.v3.Data.File> fs = FindObjects(sf, fields);
//                @object = fs.FirstOrDefault();
//                if (@object != null)
//                    paths2object[filePath] = @object;
...
//        public Google.Apis.Drive.v3.Data.File UploadFile(string localFile, string remoteBaseFolderIdOrLink, string remoteRelativeFilePath, string contentType = null, bool updateExisting = true, string fields = "id, webViewLink")
//        {
//            if (remoteRelativeFilePath == null)
//                throw new Exception2("remoteRelativeFilePath is not set.");
//            Google.Apis.Drive.v3.Data.File file = new Google.Apis.Drive.v3.Data.File
//            {
//                Name = PathRoutines.GetFileName(remoteRelativeFilePath),
//                //MimeType = getMimeType(localFile), 
//                //Description=,
//            };
//            Google.Apis.Drive.v3.Data.File folder = GetFolder(remoteBaseFolderIdOrLink, PathRoutines.GetFileDir(remoteRelativeFilePath), GettingMode.GetLatestExistingOrCreate, fields);
...
//        /// <summary>
//        /// !!!Rename it back when all the apps updated and tested.
//        /// </summary>
